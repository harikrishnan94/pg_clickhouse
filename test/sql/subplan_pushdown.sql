...
-- pins the deparsed Remote SQL via EXPLAIN and then executes, so both the
-- plan shape and the results are validated.
SET datestyle = 'ISO';
...
-- ============================================================
-- 1. Uncorrelated scalar subquery (TPC-H Q11/Q22 shape)
-- ============================================================
